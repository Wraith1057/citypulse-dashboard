      ...
      <div className="relative w-full max-w-5xl glass-card grid md:grid-cols-2 overflow-hidden animate-slide-up">
        ...
        <div className="hidden md:flex flex-col items-center justify-center p-12 gradient-primary relative">
          ...
          <div className="relative z-10 text-center space-y-4">
            ...
            <p className="text-primary-foreground/80 text-lg max-w-xs">Smart City Management Platform for modern urban governance</p>
          </div>
        </div>
        ...
        <div className="p-8 md:p-10 flex flex-col justify-center">
          ...
          <p className="text-muted-foreground mb-6 hidden md:block">Sign in to your account</p>
        </div>
